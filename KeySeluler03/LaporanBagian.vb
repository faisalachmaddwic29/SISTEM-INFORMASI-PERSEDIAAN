...
Public Class LaporanBagian
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KeySeluler03.LaporanBagian.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporanBagian
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanBagian = New LaporanBagian()
        rpt.Site = Me.Site
        Return rpt
    End Function
